...
export default function Card({ title, cat, children }) {
    ...
    const imgSrc = title=="USDT"?`${route}/tether.png`:title=="BTC"?`${route}/btc.png`:title=="ETH"?`${route}/eth.png`:title=="DOGE"?`${route}/doge.png`:title=="ADA"?`${route}/cardano.png`:`${route}/binance.png`;
    return (
        <>
